...
public class Encomenda {
    ...
    public Encomenda (Encomenda e) {    //usar getters e setters
    ...
    public Encomenda (String nomeCliente, int nif, String morada, int num_Enc, LocalDate data, ArrayList<LinhaEncomenda> linhas) {
        this.nomeCliente = nomeCliente;
        this.nif = nif;
        this.morada = morada;
        this.num_Enc = num_Enc;
