...
public class LinhaEncomenda_ficha5 {
    private String referencia;
    private String descricao;
    private double preco;   //preço sem taxas!
    private int quantidade;
    private double imposto;
    private double desconto;
    
    public LinhaEncomenda_ficha5() {
        this.referencia = "n/a";
        this.descricao = "n/a";
        this.preco = 0;
        this.quantidade = 0;
    ...
    public LinhaEncomenda_ficha5(String referencia, String descricao, double preco,
    ...
    public LinhaEncomenda_ficha5(LinhaEncomenda_ficha5 linha) {
    ...
    public LinhaEncomenda_ficha5 clone() {
        return new LinhaEncomenda_ficha5(this);
    }
    
    public boolean equals(Object obj) {
        if(obj==this) return true;
        if(obj==null || obj.getClass() != this.getClass()) return false;
        LinhaEncomenda_ficha5 le = (LinhaEncomenda_ficha5) obj;
    ...
    public String toString() {
        ...
        sb.append("Referência: ").append(this.referencia);
